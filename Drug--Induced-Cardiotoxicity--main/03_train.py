...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train the GAT cardiotoxicity model")
    parser.add_argument("--epochs", type=int, default=45, help="Number of training epochs")
    parser.add_argument("--max_graphs", type=int, default=None, help="Optional limit for quick smoke-test runs")
    ...
    if args.max_graphs is not None:
        ...
        print(f"Using smoke-test subset: {len(graphs)} graphs")
