...
**Command-line with one structured input file:**

```bash
python 06_predict_new_drug.py --input_json example_case_input.json
```

The JSON file should contain the SMILES string and all clinical details in one object, for example:
